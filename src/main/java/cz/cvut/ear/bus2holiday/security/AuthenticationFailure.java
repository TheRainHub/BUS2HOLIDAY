...
import cz.cvut.ear.bus2holiday.security.model.LoginStatus;
import cz.cvut.ear.bus2holiday.utils.Constants;
 ...
 *
 * <p>Differs from default implementation in that it returns a custom JSON response.
 */
public class AuthenticationFailure implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(
        ...
        LOG.debug(
                ...
                httpServletRequest.getParameter(Constants.USERNAME_PARAM));
